...
{
    class ClothBody : Body
    {
        public float stretchCoefficient { get; private set; }
        public float bendCoefficient { get; private set; }
        private Mesh mesh;
        public ClothBody(Mesh mesh, float radius, float mass, float stretchCoefficient, float bendCoefficient) : base(mesh.vertexCount, radius, mass)
        {
            this.mesh = mesh;
            this.stretchCoefficient = stretchCoefficient;
            this.bendCoefficient = bendCoefficient;
            initPositions();
            initConstraints();
        }
        ...
        public void addBendingConstraint(BendingConstraint b)
        {
            constraints.Add(b);
        }
    }
